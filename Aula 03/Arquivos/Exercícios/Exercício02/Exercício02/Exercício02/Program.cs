...
namespace exercicio02_arquivos_final
{
    class Arquivo
    {
        ...
        {
            sw = new StreamWriter("D:\\AVMB\\Aula 03\\Arquivos\\Exercícios\\Exercício02\\Faltantes\\" + nome + ".txt", true, Encoding.UTF8);
        }
        public void criaArquivoFigRepetidas()
        {
            sw = new StreamWriter("D:\\AVMB\\Aula 03\\Arquivos\\Exercícios\\Exercício02\\Repetidas\\" + nome + ".txt", true, Encoding.UTF8);
        }
        public void lerFigurinhasFaltantes()
        {
            string linha;
            sr = new StreamReader("D:\\AVMB\\Aula 03\\Arquivos\\Exercícios\\Exercício02\\Faltantes\\" + nome + ".txt");
            linha = sr.ReadLine();
            while (linha != null)
            {
        ...
        {
            string linha;
            sr = new StreamReader("D:\\AVMB\\Aula 03\\Arquivos\\Exercícios\\Exercício02\\Repetidas\\" + nome + ".txt");
            linha = sr.ReadLine();
            while (linha != null)
            {
                Console.WriteLine(linha);
